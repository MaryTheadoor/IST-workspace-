...
Phase 43 is complete. The standing open items remain: stable-knot -> SM
multiplicity mapping. (Phase 44 completed the BAO sound-horizon test of Phase
36's crystallization: an honest negative — the DESI DR1 ruler does not break
the H(z) degeneracy, D ~ 3 at observable z survives, discriminators remain at
higher z.) (Phase 45 completed the baryon octet Lambda-Sigma mixing: a golden
