...
| **42** | **Flavor-threshold closure + self-referential 137** | **Phase 39 boundary bug: m_t never gets 6 flavors (loop breaks at E≤t) → free-fit f(6)≈φ was an artifact. QCD upper convention (ref AT threshold uses flavors ABOVE): principled RMS 9.56%→8.78%. H42g: α⁻¹=360/φ^(2+α) fixed point = 137.0257 vs CODATA 137.0360 (−0.0075%) — 46× tighter than golden angle 137.508 (0.34%), spin-1/2 self-return on the 720° cover** | BOUNDARY RESOLVED; 137 SELF-CONSISTENT |
